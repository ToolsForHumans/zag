...
class FakeFilesystem(object):
    ...
    **Not** thread-safe when a single filesystem is mutated at the same
    ...
    :meth:`~zag.persistence.backends.impl_memory.FakeFilesystem.clear`
    at the same time could potentially end badly. It is thread-safe when only
    :meth:`~zag.persistence.backends.impl_memory.FakeFilesystem.get`
    or other read-only actions (like calling into
    :meth:`~zag.persistence.backends.impl_memory.FakeFilesystem.ls`)
