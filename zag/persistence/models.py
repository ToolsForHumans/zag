...
class AtomDetail(object):
    ...
    :ivar AtomDetail.failure: If the atom failed (due to its ``execute`` method
                   ...
                   :py:class:`~zag.types.failure.Failure` object that
    ...
    :ivar revert_failure: If the atom failed (possibly due to its ``revert``
                          ...
                          :py:class:`~zag.types.failure.Failure` object
...
class TaskDetail(AtomDetail):
    ...
    .. |tt| replace:: :py:class:`~zag.task.Task`
    """
    ...
    def merge(self, other, deep_copy=False):
        ...
        See: https://bugs.launchpad.net/zag/+bug/1452978 for
...
class RetryDetail(AtomDetail):
    ...
    .. |rt| replace:: :py:class:`~zag.retry.Retry`
    """
    ...
    def merge(self, other, deep_copy=False):
        ...
        :py:class:`~zag.types.failure.Failure` objects that
