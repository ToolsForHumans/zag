...
def _translate_failures():
    """Translates common redis exceptions into zag exceptions."""
    try:
        yield
...
class RedisJob(base.Job):
    ...
    def expires_in(self):
        ...
        :attr:`~zag.utils.redis_utils.UnknownExpire.DOES_NOT_EXPIRE` or
        :attr:`~zag.utils.redis_utils.UnknownExpire.KEY_NOT_FOUND` if it
