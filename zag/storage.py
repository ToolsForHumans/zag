...
class Storage(object):
    ...
    def inject_atom_args(self, atom_name, pairs, transient=True):
        ...
        .. note::
            ...
            the :py:meth:`~zag.storage.Storage.inject` method).
        ...
        .. warning::
            ...
            atom :py:meth:`~zag.atom.Atom.execute` and
            :py:meth:`~zag.atom.Atom.revert` arguments to
    ...
    def change_flow_state(self, state):
        ...
        :py:class:`~zag.exceptions.InvalidState` exception if transition
        is invalid.
        """
