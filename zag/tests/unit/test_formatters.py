...
class FormattersTest(test.TestCase):
    ...
    @mock.patch('zag.formatters.FailureFormatter._format_node')
    ...
    @mock.patch('zag.storage.Storage.get_execute_result')
