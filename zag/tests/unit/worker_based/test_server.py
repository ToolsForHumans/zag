...
from zag.engines.worker_based import endpoint as ep
from zag.engines.worker_based import protocol as pr
from zag.engines.worker_based import server
from zag import task as task_atom
...
class TestServer(test.MockTestCase):
    ...
    @mock.patch("zag.engines.worker_based.server.LOG.critical")
    ...
    @mock.patch("zag.engines.worker_based.server.LOG.warn")
