...
can be executed with current zag. For examples with deterministic
...
def run_example(name):
    path = root_path('zag', 'examples', '%s.py' % name)
...
def expected_output_path(name):
    return root_path('zag', 'examples', '%s.out.txt' % name)


def iter_examples():
    examples_dir = root_path('zag', 'examples')
