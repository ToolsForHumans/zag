...
from zag.flow import (LINK_INVARIANT, LINK_RETRY)  # noqa
...
class PatternCompiler(object):
    ...
    :py:class:`~.zag.exceptions.CompilationFailure` will be raised.
    ...
    :py:class:`~zag.patterns.linear_flow.Flow` with items ``a(b, c)``
    where ``a`` is a :py:class:`~zag.patterns.linear_flow.Flow` composed
