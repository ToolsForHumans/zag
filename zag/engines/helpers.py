...
def load(flow, store=None, flow_detail=None, book=None,
    ...
    engines :py:meth:`~zag.engines.base.Engine.run` method.
    ...
    :py:func:`~zag.persistence.backends.fetch` to obtain a
    viable backend.
...
def run(flow, store=None, flow_detail=None, book=None,
    ...
    :returns: dictionary of all named
              results (see :py:meth:`~.zag.storage.Storage.fetch_all`)
    """
