...
#
# This example shows a basic usage of the zag structures without involving
# the complexity of persistence. Using the structures that zag provides
...
engine = zag.engines.load(flow, store={
    'context': {
        "joe_number": 444,
        "jim_number": 555,
    }
