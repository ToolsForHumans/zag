...
#
#     python zag/examples/resume_from_backend.py
#
#   With ZooKeeper as backend
#
#     python zag/examples/resume_from_backend.py \
#       zookeeper://127.0.0.1:2181/zag/resume_from_backend/
...
with eu.get_backend() as backend:
    ...
    flow = flow_factory()
    engine = zag.engines.load(flow, flow_detail=flow_detail,
    ...
    engine2 = zag.engines.load(flow2,
