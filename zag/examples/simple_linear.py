...
#
# NOTE(harlowja): This example shows a basic usage of the zag structures
# without involving the complexity of persistence. Using the structures that
# zag provides via tasks and flows makes it possible for you to easily at
...
zag.engines.run(flow, store=dict(joe_number=444,
                                 jim_number=555))
