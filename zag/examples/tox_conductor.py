...
from zag.conductors import backends as conductors
from zag import engines
from zag.jobs import backends as boards
from zag.patterns import linear_flow
from zag.persistence import backends as persistence
...
JOBBOARD_CONF = {
    'board': 'zookeeper://localhost?path=/zag/tox/jobs',
}
